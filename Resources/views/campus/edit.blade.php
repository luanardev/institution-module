            ...
            <form action="{{route('campus.update', $campus->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input  type="text" name="code" placeholder="Enter code" class="form-control" value="{{old('code', $campus->code)}}">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input  type="text" name="name" placeholder="Enter name" class="form-control" value="{{old('name', $campus->name)}}">
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="branch">
                        ...
                        <option value="{{$branch->id}}" @if($branch == $campus->branch) selected @endif >{{$branch->name}}</option>
                        @endforeach
                      </select>
                  </div>
                </div>
